...
- spec_dir: specs/001-workflow-state-audit-safety
- repo: .
- skill_dir: /Users/lnmtan/.zcode/skills/spec-to-prod
...
- Acceptance commands (always for code tasks — run them while implementing; the closing audit re-runs them):
   TC-001: `python3 skills/spec-to-prod/tests/test_specstate.py`
