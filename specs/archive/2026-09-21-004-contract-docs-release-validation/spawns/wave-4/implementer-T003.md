# Spawn payload — implementer · node execute · wave 4
...
- spec_dir: specs/004-contract-docs-release-validation
- repo: .
- skill_dir: /Users/lnmtan/Projects/others/SpecDevKit/skills/spec-to-prod
...
- spec_dir: specs/004-contract-docs-release-validation
- Repo conventions: no AGENTS.md at the repo root — follow existing code style · CONSTITUTION: specs/CONSTITUTION.md
- Acceptance commands (always for code tasks — run them while implementing; the closing audit re-runs them):
   TC-003: `python3 skills/spec-to-prod/tests/test_check.py`
